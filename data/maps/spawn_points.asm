...
; Fly destinations
	...
	db GROUP_PRINCE, MAP_PRINCE, $05, $05 ; Later changed to $05, $0F in "SOURCE\BACKUP\SETMAP.OLD"
	db GROUP_MT_FUJI, MAP_MT_FUJI, $05, $05 ; Later changed to $08, $0F in "SOURCE\BACKUP\SETMAP.OLD"
